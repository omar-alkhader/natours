...
})({"jOhni":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "4402b7e11fa90a25";
"use strict";
...
},{}],"fyCGd":[function(require,module,exports,__globalThis) {
var global = arguments[3];
// modules are defined as an array
// [ module function, map of requires ]
//
...
(function(modules, entry, mainEntry, parcelRequireName, externals, distDir, publicUrl, devServer) {
        ...
        function localRequire(x) {
            ...
            if (Array.isArray(res)) {
                ...
                res.forEach(function(v) {
                    ...
                    var exp = v[2] || v[0];
                    var x = newRequire(id);
                    if (key === '*') Object.keys(x).forEach(function(key) {
                        if (key === 'default' || key === '__esModule' || Object.prototype.hasOwnProperty.call(m, key)) return;
                        Object.defineProperty(m, key, {
                            enumerable: true,
                            get: function() {
                                return x[key];
                    ...
                    else if (exp === '*') Object.defineProperty(m, key, {
                        enumerable: true,
                        value: x
                    });
                    else Object.defineProperty(m, key, {
                        enumerable: true,
                        get: function() {
                            if (exp === 'default') return x.__esModule ? x.default : x;
                            return x[exp];
                        }
                    });
                });
    ...
    "apl4j": [
        function(require, module1, exports, __globalThis) {
            ...
            var HMR_HOST = null;
            var HMR_PORT = 8038;
            var HMR_SERVER_PORT = 8038;
            var HMR_SECURE = false;
            var HMR_ENV_HASH = "d6ea1d42532a7575";
            var HMR_USE_SSE = false;
            module1.bundle.HMR_BUNDLE_ID = "878e632e272a3d49";
            "use strict";
            /* global HMR_HOST, HMR_PORT, HMR_SERVER_PORT, HMR_ENV_HASH, HMR_SECURE, HMR_USE_SSE, chrome, browser, __parcel__import__, __parcel__importScripts__, ServiceWorkerGlobalScope */ /*::
import type {
  HMRAsset,
...
${frame.code}`;
    ...
    "apl4j",
    "fyCGd"
], "fyCGd", "parcelRequire11c7", {});

},{}]},["jOhni","fyCGd"], "fyCGd", "parcelRequire11c7", {})
